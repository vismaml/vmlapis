...
private static final long serialVersionUID = 0L;
  ...
  public static final int QR_CODES_FIELD_NUMBER = 7;
  @SuppressWarnings("serial")
  ...
  public static final int SWISS_QR_BILLS_FIELD_NUMBER = 8;
  @SuppressWarnings("serial")
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < qrCodes_.size(); i++) {
      output.writeMessage(7, qrCodes_.get(i));
    }
    for (int i = 0; i < swissQrBills_.size(); i++) {
      output.writeMessage(8, swissQrBills_.get(i));
    }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < qrCodes_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(7, qrCodes_.get(i));
    }
    for (int i = 0; i < swissQrBills_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(8, swissQrBills_.get(i));
    }
