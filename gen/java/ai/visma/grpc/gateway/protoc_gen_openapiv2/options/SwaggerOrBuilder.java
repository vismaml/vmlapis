...
public interface SwaggerOrBuilder extends
   ...
   * @return The info.
   */
  ai.visma.grpc.gateway.protoc_gen_openapiv2.options.Info getInfo();
  /**
   * <pre>
   * Provides metadata about the API. The metadata can be used by the
   * clients if needed.
   ...
   * <code>.grpc.gateway.protoc_gen_openapiv2.options.Info info = 2 [json_name = "info"];</code>
   */
  ai.visma.grpc.gateway.protoc_gen_openapiv2.options.InfoOrBuilder getInfoOrBuilder();
   ...
   */
  java.util.List<ai.visma.grpc.gateway.protoc_gen_openapiv2.options.Scheme> getSchemesList();
  /**
   * <pre>
   * The transfer protocol of the API. Values MUST be from the list: "http",
   * "https", "ws", "wss". If the schemes is not included, the default scheme to
   ...
   */
  ai.visma.grpc.gateway.protoc_gen_openapiv2.options.Scheme getSchemes(int index);
  /**
   * <pre>
   * The transfer protocol of the API. Values MUST be from the list: "http",
   * "https", "ws", "wss". If the schemes is not included, the default scheme to
  ...
  java.util.Map<java.lang.String, ai.visma.grpc.gateway.protoc_gen_openapiv2.options.Response>
  getResponses();
  /**
   * <pre>
   * An object to hold responses that can be used across operations. This
...
ai.visma.grpc.gateway.protoc_gen_openapiv2.options.Response defaultValue);
   ...
   * <code>map&lt;string, .grpc.gateway.protoc_gen_openapiv2.options.Response&gt; responses = 10 [json_name = "responses"];</code>
   */
  ai.visma.grpc.gateway.protoc_gen_openapiv2.options.Response getResponsesOrThrow(
      java.lang.String key);
   ...
   */
  ai.visma.grpc.gateway.protoc_gen_openapiv2.options.SecurityDefinitions getSecurityDefinitions();
  /**
   * <pre>
   * Security scheme definitions that can be used across the specification.
   * </pre>
   ...
   * <code>.grpc.gateway.protoc_gen_openapiv2.options.SecurityDefinitions security_definitions = 11 [json_name = "securityDefinitions"];</code>
   */
  ai.visma.grpc.gateway.protoc_gen_openapiv2.options.SecurityDefinitionsOrBuilder getSecurityDefinitionsOrBuilder();
   ...
   */
  java.util.List<ai.visma.grpc.gateway.protoc_gen_openapiv2.options.SecurityRequirement> 
      getSecurityList();
  /**
   * <pre>
   * A declaration of which security schemes are applied for the API as a whole.
   ...
   * <code>repeated .grpc.gateway.protoc_gen_openapiv2.options.SecurityRequirement security = 12 [json_name = "security"];</code>
   */
  ai.visma.grpc.gateway.protoc_gen_openapiv2.options.SecurityRequirement getSecurity(int index);
  /**
   * <pre>
   * A declaration of which security schemes are applied for the API as a whole.
   * The list of values describes alternative security schemes that can be used
   ...
   * <code>repeated .grpc.gateway.protoc_gen_openapiv2.options.SecurityRequirement security = 12 [json_name = "security"];</code>
   */
  java.util.List<? extends ai.visma.grpc.gateway.protoc_gen_openapiv2.options.SecurityRequirementOrBuilder> 
   ...
   * <code>repeated .grpc.gateway.protoc_gen_openapiv2.options.SecurityRequirement security = 12 [json_name = "security"];</code>
   */
  ai.visma.grpc.gateway.protoc_gen_openapiv2.options.SecurityRequirementOrBuilder getSecurityOrBuilder(
      int index);
