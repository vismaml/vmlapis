...
public interface SecuritySchemeOrBuilder extends
   ...
   * @return The type.
   */
  ai.visma.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Type getType();
   ...
   * @return The in.
   */
  ai.visma.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.In getIn();
   ...
   * @return The flow.
   */
  ai.visma.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Flow getFlow();
   ...
   * @return The scopes.
   */
  ai.visma.grpc.gateway.protoc_gen_openapiv2.options.Scopes getScopes();
  /**
   * <pre>
   * The available scopes for the OAuth2 security scheme.
   * Valid for oauth2.
