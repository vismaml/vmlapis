...
//
//	mockgen -source gen/go/ssn/annotator/v1/annotator_grpc.pb.go -destination gen/go/ssn/annotator/v1/mock/mock_annotator_grpc.go
//
...
func (mr *MockDocumentAnnotatorClientMockRecorder) AnnotateDocument(ctx, in any, opts ...any) *gomock.Call {
...
func (mr *MockDocumentAnnotatorClientMockRecorder) AnswerDocumentQuestion(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
...
// AnnotateDocument indicates an expected call of AnnotateDocument.
func (mr *MockDocumentAnnotatorServerMockRecorder) AnnotateDocument(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// AnswerDocumentQuestion indicates an expected call of AnswerDocumentQuestion.
func (mr *MockDocumentAnnotatorServerMockRecorder) AnswerDocumentQuestion(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
