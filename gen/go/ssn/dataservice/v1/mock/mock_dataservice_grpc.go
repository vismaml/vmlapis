...
func (m *MockDataServiceClient) CalculateAnnotationProcessMetrics(ctx context.Context, in *dataservice.AnnotationProcessMetricsRequest, opts ...grpc.CallOption) (*dataservice.FeedbackMetrics, error) {
	m.ctrl.T.Helper()
...
// CalculateAnnotationProcessMetrics mocks base method.
func (m *MockDataServiceServer) CalculateAnnotationProcessMetrics(arg0 context.Context, arg1 *dataservice.AnnotationProcessMetricsRequest) (*dataservice.FeedbackMetrics, error) {
	m.ctrl.T.Helper()
