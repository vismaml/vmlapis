...
class PredictResponse(_message.Message):
    ...
    RECEIVER_NAME_FIELD_NUMBER: _ClassVar[int]
    RECEIVER_VAT_NUMBER_FIELD_NUMBER: _ClassVar[int]
    COMPLETABLE_FIELD_NUMBER: _ClassVar[int]
