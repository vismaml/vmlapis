...
class VatDistribution(_message.Message):
    __slots__ = ("percentage", "total_vat", "model_metadata", "page_ref", "total_excl_vat", "total_incl_vat")
    PERCENTAGE_FIELD_NUMBER: _ClassVar[int]
    TOTAL_VAT_FIELD_NUMBER: _ClassVar[int]
    MODEL_METADATA_FIELD_NUMBER: _ClassVar[int]
    PAGE_REF_FIELD_NUMBER: _ClassVar[int]
    ...
    total_excl_vat: _containers.RepeatedCompositeFieldContainer[Candidate]
    total_incl_vat: _containers.RepeatedCompositeFieldContainer[Candidate]
    def __init__(self, percentage: _Optional[_Iterable[_Union[Candidate, _Mapping]]] = ..., total_vat: _Optional[_Iterable[_Union[Candidate, _Mapping]]] = ..., model_metadata: _Optional[_Union[ModelSpec, _Mapping]] = ..., page_ref: _Optional[int] = ..., total_excl_vat: _Optional[_Iterable[_Union[Candidate, _Mapping]]] = ..., total_incl_vat: _Optional[_Iterable[_Union[Candidate, _Mapping]]] = ...) -> None: ...
