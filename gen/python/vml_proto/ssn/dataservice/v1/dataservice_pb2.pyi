...
class Document(_message.Message):
    __slots__ = ("ta", "bytes", "id", "consumer", "tags", "true_values", "prediction_values", "feedback_time", "prediction_confidences", "prediction_metadata", "requested_features", "document_text")
...
class TrueValues(_message.Message):
    ...
    KSEF_FIELD_NUMBER: _ClassVar[int]
...
class CallsPerMonth(_message.Message):
    __slots__ = ("calls", "month_name", "total_batch_size", "year")
    ...
    year: int
    def __init__(self, calls: _Optional[int] = ..., month_name: _Optional[str] = ..., total_batch_size: _Optional[int] = ..., year: _Optional[int] = ...) -> None: ...
