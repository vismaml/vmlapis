...
def add_TransactionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateTransaction': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=ssn_dot_asyncton_dot_v1_dot_asyncton__pb2.CreateTransactionRequest.FromString,
                    response_serializer=ssn_dot_asyncton_dot_v1_dot_asyncton__pb2.CreateTransactionResponse.SerializeToString,
            ),
            'GetTransactionResults': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTransactionResults,
                    request_deserializer=ssn_dot_asyncton_dot_v1_dot_asyncton__pb2.GetTransactionResultsRequest.FromString,
                    response_serializer=ssn_dot_asyncton_dot_v1_dot_asyncton__pb2.GetTransactionResultsResponse.SerializeToString,
            ),
            'GetTransactionStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTransactionStatus,
                    request_deserializer=ssn_dot_asyncton_dot_v1_dot_asyncton__pb2.GetTransactionStatusRequest.FromString,
                    response_serializer=ssn_dot_asyncton_dot_v1_dot_asyncton__pb2.GetTransactionStatusResponse.SerializeToString,
            ),
            'DeleteTransaction': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteTransaction,
                    request_deserializer=ssn_dot_asyncton_dot_v1_dot_asyncton__pb2.DeleteTransactionRequest.FromString,
