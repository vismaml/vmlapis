...
from ssn.type import hotel_dates_pb2 as _hotel_dates_pb2
...
class Feature(_message.Message):
    ...
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        OCR_LINE_PL_CREDITOR_ID: _ClassVar[Feature.Type]
    ...
    OCR_LINE_PL_CREDITOR_ID: Feature.Type
...
class DocumentAnnotatorResponse(_message.Message):
    ...
    HOTEL_DATES_FIELD_NUMBER: _ClassVar[int]
    PURCHASE_LINES_DETAILS_FIELD_NUMBER: _ClassVar[int]
    VAT_DISTRIBUTION_DETAILS_FIELD_NUMBER: _ClassVar[int]
    STRUCTURED_SUPPLIER_ADDRESS_FIELD_NUMBER: _ClassVar[int]
    STRUCTURED_RECEIVER_ADDRESS_FIELD_NUMBER: _ClassVar[int]
    ...
    hotel_dates: _hotel_dates_pb2.HotelDates
